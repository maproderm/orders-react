                                ...
                                {orders.map((order) =>{
                                    return (
                                        <tr key={order.id} className="border-b dark:border-gray-600 hover:bg-gray-100 dark:hover:bg-gray-700">
                                            <td className="px-4 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white text-center">{order.id}</td>                                            
                                            ...
                                            <td className="px-4 py-4"><span className="bg-yellow-100 text-yellow-800 text-xs font-medium mr-2 px-2.5 py-0.5 rounded-full dark:bg-yellow-900 dark:text-yellow-300">{order.status}</span></td>
                                        </tr>
                                    );
                                })}
                            </tbody>
